 ...
 */
include("controller/php/inc/functions.inc.php");
include("controller/php/inc/users.class.php");
 ...
 */
include_once("controller/php/controllers/base_controller.php");
...
$filename_ctrl = "controller/php/controllers/$ctrl_name.php";
